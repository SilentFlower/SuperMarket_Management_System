            ...
            <div id="mianbao">
                ...
                <div id="url_name2">
                    <ul class="breadcrumb">
                        ...
                        <li class="active"><a href="${pageContext.request.contextPath}/goodsStatistics/get_goodsSaleStatistics">库存盘点
        ...
        <div style="height: 92%;padding-top: 10px;">
            <div id="right-bottom" style="height: 100%;border-radius: 10px;">
                ...
                <div id="choose_button">
                    ...
                    <div id="start">
                        <span>开始时间</span>：<input type="number" id="search_goods_start">
                    </div>

                    <div id="end">
                        <span>结束时间</span>：<input type="number" id="search_goods_end">
                    </div>
